...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>    
 <%
 	Member member1 = new Member(1,"test","test","1999-01-02");

 %>
<jsp:useBean id="member2" class="tw.ws1.classes.Member"></jsp:useBean>
...
<jsp:setProperty property="birthday" name="member2" value="1888-08-03"/>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
