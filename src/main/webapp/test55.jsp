...
<body>
	...
	Taipei: <fmt:formatDate value="${now }" pattern="yyyy-MM-dd HH:mm:ss"/><hr>
	<fmt:setTimeZone value="Asia/Tokyo"/>
	Japan: <fmt:formatDate value="${now }" pattern="yyyy-MM-dd HH:mm:ss"/><hr>
	<fmt:setTimeZone value="Europe/Berlin"/>
	German: <fmt:formatDate value="${now }" pattern="yyyy-MM-dd HH:mm:ss"/><hr>
